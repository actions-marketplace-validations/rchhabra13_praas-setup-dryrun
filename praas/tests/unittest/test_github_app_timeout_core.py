"""Unit tests for ``praas.servers.utils.DefaultDictWithTimeout`` and a few
helper functions in ``praas.servers.github_app``.
...
from praas.servers import github_app
from praas.servers import utils as servers_utils
from praas.servers.utils import DefaultDictWithTimeout
...
def fake_clock(monkeypatch):
    """Replace ``time.monotonic`` in praas.servers.utils with a controllable clock."""
    state = {"t": 1_000_000.0}
