...
from praas.algo.types import EDIT_TYPE
from praas.config_loader import get_settings, global_settings
from praas.mosaico.diff_provider import DiffInputProvider, parse_unified_diff
...
class TestProviderRegistration:
    def test_registry_has_mosaico_diff_and_originals_intact(self):
        import praas.mosaico.provider_registration  # noqa: F401 (triggers setdefault)
...
async def _run_tool_via_spy(monkeypatch, isolated_settings, verb, canned_yaml, second_yaml=""):
    ...
    ok = await Praas().handle_request("mosaico://supplied-diff", ["/" + verb])
