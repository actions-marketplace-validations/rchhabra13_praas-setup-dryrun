"""
Security and behavior tests for praas.custom_merge_loader.
...
# Import praas.config_loader first (for its module-level side effects) to
# complete the config_loader import chain and avoid the circular import between
# praas.log and praas.custom_merge_loader.
importlib.import_module("praas.config_loader")
custom_merge_loader = importlib.import_module("praas.custom_merge_loader")
...
# ---------------------------------------------------------------------------
# validate_file_security: representative safe Praas config does not raise
# ---------------------------------------------------------------------------

def test_safe_praas_config_does_not_raise():
    data = {
        "config": {
            "model": "gpt-4",
