...
shipped gpt-5.x defaults), since Praas's LiteLLMAIHandler never sends 'stop'."""
import litellm
import pytest
from starlette.testclient import TestClient

import praas.mosaico.server as server_mod
from praas.config_loader import get_settings
from praas.mosaico.executor import health_check
