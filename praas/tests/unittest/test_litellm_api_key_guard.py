...
from praas.algo.ai_handlers.litellm_ai_handler import DUMMY_LITELLM_API_KEY, LiteLLMAIHandler
...
class TestApiKeyGuard:
    ...
    async def test_dummy_key_not_forwarded(self, monkeypatch):
        ...
        with patch("praas.algo.ai_handlers.litellm_ai_handler.acompletion",
...
class TestPlaceholderDoesNotShadowProviderEnvVars:
    ...
    def test_openrouter_env_key_wins_over_placeholder(self, monkeypatch):
        ...
        OPENROUTER_API_KEY env var rather than Praas's [openrouter] settings.
        """
        from litellm import main as litellm_main
