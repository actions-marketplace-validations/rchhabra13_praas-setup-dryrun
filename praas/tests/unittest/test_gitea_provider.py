...
class TestGiteaProvider:
    @patch('praas.git_providers.gitea_provider.get_settings')
    @patch('praas.git_providers.gitea_provider.giteapy.ApiClient')
    def test_gitea_provider_auth_header(self, mock_api_client_cls, mock_get_settings):
        ...
        from praas.git_providers.gitea_provider import RepoApi
    ...
    def test_gitea_provider_preserves_non_utf8_text_file_content(self, mock_api_client_cls, mock_get_settings):
        # Regression for the Praas review on #2440: non-UTF-8 *text* (e.g. UTF-16)
    ...
    def test_get_repo_settings_returns_bytes(self):
        ...
        provider.repo = 'repo'
        provider.sha = 'sha1'
        provider.repo_settings = '.praas.toml'
    ...
    def test_get_repo_settings_empty_bytes_when_unset_or_missing(self):
        ...
        empty.repo = 'repo'
        empty.sha = 'sha1'
        empty.repo_settings = '.praas.toml'
...
class TestGiteaProviderAddFileDiff:
    ...
    @patch("praas.git_providers.gitea_provider.giteapy.RepositoryApi")
