...
import praas.algo.ai_handlers.openai_ai_handler as openai_handler
from praas.algo.run_details import get_run_details, init_run_details
...
async def test_langchain_handler_records_successful_call_without_usage(monkeypatch):
    ...
    monkeypatch.delitem(sys.modules, "praas.algo.ai_handlers.langchain_ai_handler", raising=False)
    langchain_handler = importlib.import_module("praas.algo.ai_handlers.langchain_ai_handler")
