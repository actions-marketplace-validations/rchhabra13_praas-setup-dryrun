...
praas/mosaico/env_bridge.py registers 'langfuse_otel' as the Langfuse callback
...
These tests assert the environment, not praas logic, hence a file of their own
...
# litellm's base dependencies, so it must remain available in praas's environment.
