...
from praas.algo.run_details import init_run_details, record_ai_call, record_model_used
from praas.config_loader import get_settings
from praas.tools.pr_code_suggestions import PRCodeSuggestions
from praas.tools.pr_description import PRDescription
from praas.tools.pr_reviewer import PRReviewer
...
"""
        ...
        monkeypatch.setattr("praas.tools.pr_reviewer.init_run_details", _seeded_init_run_details)
        monkeypatch.setattr("praas.tools.pr_reviewer.extract_and_cache_pr_tickets", _noop_async)
        monkeypatch.setattr("praas.tools.pr_reviewer.retry_with_fallback_models", _noop_async)
...
async def test_pr_description_appends_run_details_only_when_enabled(monkeypatch):
    ...
    try:
        ...
        monkeypatch.setattr("praas.tools.pr_description.init_run_details", _seeded_init_run_details)
        monkeypatch.setattr("praas.tools.pr_description.extract_and_cache_pr_tickets", _noop_async)
        monkeypatch.setattr("praas.tools.pr_description.retry_with_fallback_models", _noop_async)
...
async def test_pr_code_suggestions_appends_run_details_only_when_enabled(monkeypatch):
    ...
    try:
        ...
        monkeypatch.setattr("praas.tools.pr_code_suggestions.init_run_details", _seeded_init_run_details)
        monkeypatch.setattr("praas.tools.pr_code_suggestions.retry_with_fallback_models", _fake_retry)
...
async def test_pr_code_suggestions_appends_run_details_when_no_suggestions(monkeypatch, gfm_supported):
    ...
    try:
        ...
        monkeypatch.setattr("praas.tools.pr_code_suggestions.init_run_details", _seeded_init_run_details)
        monkeypatch.setattr("praas.tools.pr_code_suggestions.retry_with_fallback_models", _fake_retry_empty)
