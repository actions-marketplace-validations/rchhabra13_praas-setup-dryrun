"""Builds the MOSAICO A2A agent card for praas.
...
AGENT_NAME = "praas Solution Agent"
DEFAULT_PORT = 9000
...
def build_agent_card() -> AgentCard:
    ...
    return AgentCard(
        name=AGENT_NAME,
        description="praas solution agent for pull-request and unified-diff code review. "
