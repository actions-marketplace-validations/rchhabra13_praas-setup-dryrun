...
from praas.algo.utils import clip_tokens, get_max_tokens, load_yaml, ModelType
...
def extract_model_answer_and_relevant_sources(ai_response: str) -> str | None:
    ...
    # (for more details, see here: https://github.com/Praas/praas-pro/blob/main/praas/tools/pr_help_message.py#L173)
    """
    For example:
