...
from praas.algo.pr_processing import get_pr_diff, retry_with_fallback_models
from praas.algo.token_handler import TokenHandler
from praas.algo.utils import ModelType, show_relevant_configurations
...
class PRUpdateChangelog:
    ...
    def _push_changelog_update(self, new_file_content, answer):
        ...
        try:
            ...
            # Fall back to a regular PR comment when the review API call fails.
