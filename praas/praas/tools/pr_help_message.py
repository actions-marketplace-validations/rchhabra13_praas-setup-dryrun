...
from praas.algo.pr_processing import retry_with_fallback_models
from praas.algo.token_handler import TokenHandler
from praas.algo.utils import ModelType, clip_tokens, load_yaml, get_max_tokens
from praas.config_loader import get_settings
from praas.git_providers import BitbucketServerProvider, GithubProvider, get_git_provider_with_context
        ...
        try:
            if self.question_str:
                ...
                if response_str:
                    ...
                    base_path = "https://praas-docs.praas.ai/"
                ...
                pr_comment = "## praas Walkthrough 🤖\n\n"
                pr_comment += "Welcome to praas, an AI-powered tool for automated pull request analysis, feedback, suggestions and more."""
                pr_comment += "\n\nHere is a list of tools you can use to interact with praas:\n"
                base_path = "https://praas-docs.praas.ai/tools"
                ...
                if isinstance(self.git_provider, GithubProvider) and not get_settings().config.get('disable_checkboxes', False):
                    ...
                    pr_comment += "</table>\n\n"
                    pr_comment += f"""\n\n(1) Note that each tool can be [triggered automatically](https://praas-docs.praas.ai/usage-guide/automations_and_usage/#github-app-automatic-tools-when-a-new-pr-is-opened) when a new PR is opened, or called manually by [commenting on a PR](https://praas-docs.praas.ai/usage-guide/automations_and_usage/#online-usage)."""
                    ...
                    pr_comment += "</table>\n\n"
                    pr_comment += f"""\n\nNote that each tool can be [invoked automatically](https://praas-docs.praas.ai/usage-guide/automations_and_usage/) when a new PR is opened, or called manually by [commenting on a PR](https://praas-docs.praas.ai/usage-guide/automations_and_usage/#online-usage)."""
