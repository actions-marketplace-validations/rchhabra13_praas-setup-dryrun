...
PRAAS_TOML_KEY = 'praas'

current_dir = dirname(abspath(__file__))

dynconf_kwargs = {'core_loaders': [], # DISABLE default loaders, otherwise will load toml files more than once.
                           'loaders': ['praas.custom_merge_loader', 'dynaconf.loaders.env_loader'], # Use a custom loader to merge sections, but overwrite their overlapping values. Also support ENV variables to take precedence.
...
if pyproject_path is not None:
    get_settings().load_file(pyproject_path, env=f'tool.{PRAAS_TOML_KEY}')
