...
class BitbucketProvider(GitProvider):
    ...
    def get_repo_settings(self):
        ...
        try:
            url = (f"https://api.bitbucket.org/2.0/repositories/{self.workspace_slug}/{self.repo_slug}/src/"
                   f"{self.pr.destination_branch}/.praas.toml")
            ...
            if response.status_code == 200:  # found
                ...
                get_logger().warning(f"Failed to load local .praas.toml file, status: {response.status_code}")
        except Exception as e:
    ...
    def _get_global_repo_settings(self):
        # Load a workspace-wide <workspace>/praas-settings/.praas.toml.
    ...
    def _fetch_global_repo_settings(self, workspace):
        ...
        repo_url = f"https://api.bitbucket.org/2.0/repositories/{workspace}/praas-settings"
        ...
        file_resp = requests.request(
            "GET", f"{repo_url}/src/{main_branch}/.praas.toml", headers=self.headers)
    ...
    # Example: git clone git clone https://bitbucket.org/praas/praas.git and branch: main -> prefix: "https://bitbucket.org/praas/praas/src/main", suffix: ""
