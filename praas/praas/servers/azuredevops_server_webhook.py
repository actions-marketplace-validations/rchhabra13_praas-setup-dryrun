...
# The server listens for incoming webhooks from Azure DevOps Server and forwards them to praas.
...
async def _perform_commands_azure(commands_conf: str, agent: Praas, api_url: str, log_context: dict):
...
async def handle_request_azure(data, log_context):
    if data["eventType"] == "git.pullrequest.created":
        ...
        await _perform_commands_azure("pr_commands", Praas(), pr_url, log_context)
        return JSONResponse(
