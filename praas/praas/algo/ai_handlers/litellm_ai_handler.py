...
from praas.algo import (CLAUDE_EXTENDED_THINKING_MODELS,
...
from praas.algo.run_details import record_ai_call
from praas.algo.utils import ReasoningEffort, get_version
...
class LiteLLMAIHandler(BaseAiHandler):
    ...
    def _resolve_cache_control_injection_points():
        ...
        Accepts a native TOML array in the [litellm] section of configuration.toml / .praas.toml,
                ...
                if img_path:
                    try:
                        ...
                        if r.status_code == 404:
                            error_msg = f"The image link is not [alive](img_path).\nPlease repost the original image as a comment, and send the question again with 'quote reply' (see [instructions](https://praas-docs.praas.ai/tools/ask/#ask-on-images-using-the-pr-code-as-context))."
